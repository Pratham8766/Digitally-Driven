      ...
      <div className="card-container">
          <div className="card">
            ...
            <div className="card-content">
              ...
              <p className="card-text">
                Our SEO services are designed to help your website rank higher
                in search engine results pages (SERPs), which can lead to
                increased traffic and more leads for your business.
              </p>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div className="card-content">
              ...
              <p className="card-text">
                Social media has become an essential part of any digital
                marketing strategy. Our team can help you create and execute a
                social media marketing plan that drives engagement, builds brand
                awareness, and generates leads for your business
              </p>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div className="card-content">
              ...
              <p className="card-text">
                Email marketing is a cost-effective way to stay in touch with
                your customers and keep them engaged with your brand. Our email
          ...
          <div className="card">
            ...
            <div className="card-content">
              ...
              <p className="card-text">
                Your website is often the first impression your customers have
                of your business. Our web design and development services can
                help you create a website that is not only visually appealing
                but also functional and user-friendly. We use the latest web
                design and development techniques to create websites that are
