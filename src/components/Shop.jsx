  ...
  return (
    ...
    <div className="ad-container">
      <div className="ad-card-1">
        ...
        <Link to="https://www.thesouledstore.com/men" className="button">Visit Site</Link>
      </div>
    </div>
    <div className="ad-container">
      <div className="ad-card-2">
        ...
        <Link to="https://homafy.com/" className="button">Visit Site</Link>
      </div>
      <div className="ad-card-3">
        ...
        <Link to="https://www.shoppersstop.com/?ef_id=CjwKCAjwjYKjBhB5EiwAiFdSfhIdLydf-3Ub--DNLuMXs8GBZY3V1Ya2Pmlr_wzdzA7fWOEg_tpqbRoCa3IQAvD_BwE:G:s&utm_source=google&utm_medium=cpc&utm_campaign=Sok_Srch_Desktop_SS_Brand_RLSA" className="button">Visit Site</Link>
      </div>
    </div>
    </>
  )
