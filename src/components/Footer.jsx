        ...
        <footer className="foot">
            <div className="row">
                <div className="col">
                    ...
                    <p>Digitally Driven - Empowering your online presence through innovative marketing strategies. Connect with us to accelerate your digital growth today.</p>
                </div>
                <div className="col">
                ...
                <div className="col">
                    <h3>Legal <div className="underline"><span></span></div></h3>
                    <ul>
